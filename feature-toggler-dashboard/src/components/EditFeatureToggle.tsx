...
const CreateFeatureToggle = ({editFeatureToggle, onCloseWindow, onCreateNewFeatureToggle}: CreateToggleProps) => {
    // @ts-ignore
    ...
    const changesWereMade = () => {
        ...
        return ((editFeatureToggle.feature_name !== newFeatureToggle.name) || 
        ...
        <>
            <div className="toggle-details-window text-left w-full sm:w-3/4 md:w-2/5">
                ...
                <div>
                    {
                        editFeatureToggle && (
                            <h3 className="font-bold mb-8">Edit feature toggle</h3>
                        )
                    }
                    {
                        !editFeatureToggle && (
                            <h3 className="font-bold mb-8">Add new feature toggle to <span className="capitalize">project</span></h3>
                        )
                    }

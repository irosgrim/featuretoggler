...
const ProjectSettings = ({ currentProject, onProjectDelete }: ProjectSettingsProps): any => {
	...
	const handleDeleteProject = async () => {
		if (deleteProject) {
			await deleteProjectWithId(deleteProject);
			setDeleteProject('');
			onProjectDelete();
		}
	};
				...
				<>
					...
					<div className="md:flex">
						...
						<button
							type="button"
							className={
								updateProjectNameButtonEnabled()
									? 'border border-blue-400 bg-blue-50 rounded-md p-2 md:ml-4'
									: 'border border-blue-400 bg-blue-50 rounded-md p-2 md:ml-4 opacity-50 cursor-auto'
							}
					...
					<div className="relative">
							...
							<div className="absolute -top-10 bg-red-50 rounded-md p-4 w-1/3 mt-8 shadow-lg border border-solid">
								...
								<div>
									...
									<button
										...
										className={
											enableDeleteProject()
												? 'mt-4 border border-red-400 bg-red-50 rounded-md p-2'
												: 'mt-4 border border-red-400 bg-red-50 rounded-md p-2 opacity-50 cursor-auto'
										}
						...
						>
							<p className="font-bold text-red-500">Delete project</p>
							<div className="ml-4">
								<svg

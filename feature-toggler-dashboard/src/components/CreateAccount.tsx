...
const CreateAccount: React.FC = (): React.ReactElement => {
	...
	return (
		<div className="w-1/3 mx-auto">
			...
			<form className="mt-8" onSubmit={(e) => createNewAccount(e)}>
				...
				<input type="text" id="organization" name="organization" className="border border-gray-400 rounded-md p-2 w-100" />
				<label htmlFor="name" className="block font-bold">
					Name
				</label>
				<input type="text" id="name" name="name" className="border border-gray-400 rounded-md p-2 w-100" />
				<label htmlFor="email" className="block font-bold">
					Email
				</label>
				<input type="email" id="email" name="email" className="border border-gray-400 rounded-md p-2 w-100" />
				<label htmlFor="username" className="block font-bold">
					Username
				</label>
				<input type="text" id="username" name="username" className="border border-gray-400 rounded-md p-2 w-100" />
				...
				<div className="mt-4">
					<button type="submit" className="border-2 border-gray-400 rounded-md p-3 bg-white hover:bg-blue-100 hover:border-blue-400">
						Create account
					</button>
				</div>
			</form>
